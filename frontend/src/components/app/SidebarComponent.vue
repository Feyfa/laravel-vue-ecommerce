<template>
  <ul class="sidebar h-screen overflow-y-auto w-[15%] p-4 border-r-2 border-r-neutral-300 bg-[rgba(255,255,255,.8)] pt-[4.5rem] flex flex-col gap-5 text-lg shadow-neutral-500 shadow-lg">
